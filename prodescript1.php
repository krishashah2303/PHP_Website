...
if(empty($_SESSION['user_name'])){
    echo ("<script LANGUAGE='javaScript'>
            window.alert('Log in to view book and user details!');
...
$sql="SELECT book.b_id,book.name,category.cname,sub_category.subcat_name,book.author,
book.amount,book.qty,book.image,book.edition,book.created_at,user.uname,user.email,
user.mobile,user.u_id FROM category inner join book on book.cat_id = category.cat_id inner join 
sub_category on book.subcat_id = sub_category.subcat_id inner join user on 
book.u_id = user.u_id  where b_id='$_GET[id]'";
...
<select style="width:250px;" name="quantity">
...
<br>
<br>
<input type="text" class="form-control"  name="address" placeholder="deliver to" required autocomplete="on">
<br>
