...
<div font-size:50px>
By clicking "post", you agree to our <a href="terms.php"font-color:blue><u>terms of use.</u></a>
</div>
<br>
<button class="btn btn-outline-dark" type="submit" name="submit" value="submit" class="btn-btn-default"> POST  </button>
<br>
<br>
</form>
</div>
