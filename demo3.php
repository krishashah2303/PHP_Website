...
<?php
include "config.php";
$sql = "SELECT `b_id`, `name`, `author`, `amount`, `image`, `edition` FROM book where subcat_id=6 && cat_id=1 order by b_id asc";
          ...
          <form>
            <div class="card">
              ...
              <div>
                ...
                <button class="btn btn-warning flex-fill"><a href="prodescript.php?id=<?php echo $row['b_id']; ?> ">Buy now  </a></button>
                </div>
              </div>
            </div>
          </form>
